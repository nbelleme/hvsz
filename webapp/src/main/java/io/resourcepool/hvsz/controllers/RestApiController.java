...
public class RestApiController {
    ...
    public
    @ResponseBody
    List<Game> greeting(@RequestParam(value = "name", defaultValue = "World") String name) {
    ...
    public
    @ResponseBody
    Game newGame(@RequestParam(value = "key", defaultValue = "1") String key) {
    ...
    public
    @ResponseBody
    Game getGame(@PathVariable(value = "id") Long id) {
